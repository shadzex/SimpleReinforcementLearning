...
from base import BaseRLAlgorithm, Hyperparameters
...
def run(algorithm_class):
    ...
    parser.add_argument('-f', '--evaluate_freq', type=int, default=-1)
    parser.add_argument('-m', '--max_iteration', type=int, default=1000000)
    parser.add_argument('-x', '--explore_iteration', type=int, default=25000)
